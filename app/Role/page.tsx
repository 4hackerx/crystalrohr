...
const RoleSelectionPage = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-start py-20 bg-black text-white px-4">
      ...
      <Link href="/user-dashboard" className='hover:scale-110 transition duration-100 ease-in-out'>
        ...
        <Link href="/node-dashboard"  className='hover:scale-110 transition duration-100 ease-in-out'>
