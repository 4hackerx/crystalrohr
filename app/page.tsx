...
const page = () => {
  return (
    <div className="h-screen  bg-gradient-to-r from-black to-[#550EFB]">
      <main className="container w-screen">
          <section className="text-center h-screen flex items-center justify-center gap-3 flex-col">
            ...
            <a href="#cta" className="bg-blue-600 text-white px-6 py-3 rounded-full text-lg font-semibold hover:bg-blue-700 transition duration-300">Get Started</a>
          </section>
      </main>
    </div>
  )
